...
from app.routers.test_cases_route import testcase_router
# from app.config.agent_initialization import gemini_model
from app.routers.java_routes import java_router
from app.routers.draft_routes import draft_router
from fastapi.middleware.cors import CORSMiddleware
from app.utils.redis_utils import start_redis_server, stop_redis_server
from app.utils.celery_utils import start_celery_worker, stop_celery_worker
...
async def lifespan(app: FastAPI):
    ...
    # SHUTDOWN
    # --------------------------------------
    logger.info("FastAPI shutting down… Attempting to stop Redis.")
    stop_celery_worker()
    stop_redis_server()
